...
import net.chuiev.selcommittee.repository.entity.Faculty;
...
public class FacultyRepository implements Repository<Faculty> {
    ...
    @Override
    public Faculty get(Faculty entity) throws SQLException {
        String sql = "SELECT * FROM Faculty WHERE id="+entity.getId()+ ";";
