...
/**
 * Command sort list of faculties on page with all faculties by number of budget seats.
 *
 * @author Oleksii Chuiev
 */
public class SortFacultiesByBudgetCommand extends Command {
    private static final Logger LOG = Logger.getLogger(SortFacultiesByBudgetCommand.class);
