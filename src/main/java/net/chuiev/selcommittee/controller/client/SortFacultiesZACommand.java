...
/**
 * Command sort list of faculties on page with all faculties in language order from Z to A.
 *
 * @author Oleksii Chuiev
 */
public class SortFacultiesZACommand extends Command {
    private static final Logger LOG = Logger.getLogger(SortFacultiesZACommand.class);
