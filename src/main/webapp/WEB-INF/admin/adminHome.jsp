...
<input type="button" value="Добавить новый факультет" class="submit-btn"
       onclick="document.location.href='controller?command=addNewFacultyForward'">
<br>
<br>
<input type="button" value="Удалить факультет" class="submit-btn"
       onclick="document.location.href='controller?command=deleteFacultyForward'">
<br>
<br>
<input type="button" value="Редактировать факультет" class="submit-btn"
       onclick="document.location.href='controller?command=editFacultyForward'">
<br>
<br>
<input type="button" value="Заблокировать абитуриента" class="submit-btn"
       onclick="document.location.href='controller?command=blockEnrolleeForward'">
<br>
<br>
<input type="button" value="Разблокировать абитуриента" class="submit-btn"
       onclick="document.location.href='controller?command=unblockEnrolleeForward'">
<br>
<br>
<input type="button" value="Сформировать ведомость" class="submit-btn"
